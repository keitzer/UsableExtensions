...
/// Invocation Count
public func invoke<T: XYZMockable>(_ name: String, times: Int = 1) -> MatcherFunc<T> {
...
/// Equatable
public func invoke<T: XYZMockable, E: Equatable>(_ name: String, atInvocation invocationIndex: Int = 0, withParameter parameter: E?, at parameterIndex: Int = 0) -> MatcherFunc<T> {
    return MatcherFunc { actualExpression, failureMessage in
...
/// Identity
public func invoke<T: XYZMockable, E: AnyObject>(_ name: String, atInvocation invocationIndex: Int = 0, withIdenticalParameter parameter: E?, at parameterIndex: Int = 0) -> MatcherFunc<T> {
    return MatcherFunc { actualExpression, failureMessage in
...
/// Closure Matcher
public func invoke<T: XYZMockable, U>(_ name: String, atInvocation invocationIndex: Int = 0, atParameterIndex parameterIndex: Int = 0, withMatcher matcher: @escaping ((U?) -> Bool?)) -> MatcherFunc<T> {
    return MatcherFunc { actualExpression, failureMessage in
